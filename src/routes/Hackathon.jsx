          ...
          <div className="hero">
            <div>
              ...
              <div className="buttons-list">
                ...
                <a className="btn" href="https://events.humanitix.com/code-network-winter-hackathon-pitch-night-2024">
                  Projects Showcase Night
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="edges">
        <div>
          ...
          <div style={{ maxWidth: "80ch", margin: "0 auto" }}>
            ...
            <p>
              In a hackathon, you'll usually work in teams of similarly interested IT students and professionals. And you'll have the
            ...
            <p>
              ...
              night ready to go! Stay tuned to our socials for more information, ask questions and be notified about any updates.
            </p>
          </div>
        </div>
        <br />
